...
const VERSIONS = {
  "4": {
    "4.0.8": "https://use-context-menu.now.sh/"
  },
  "3": {
    "3.0.6":
      "https://use-context-menu-au2wmqbbr-brian-vaughns-projects.vercel.app/"
  },
  "2": {
    "2.1.7":
      "https://use-context-menu-ca7gk2gh5-brian-vaughns-projects.vercel.app/",
    "2.0.23": ""
  },
  "1": {
    "1.0.10": ""
  ...
  return (
    <li className="list-disc">
      ...
      <ExternalLink
        ...
        className="ml-4"
        href={`https://github.com/bvaughn/use-context-menu/tree/${version}`}
      >
