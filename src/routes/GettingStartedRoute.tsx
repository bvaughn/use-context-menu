...
export default function GettingStartedRoute() {
  return (
    <Box direction="column" gap={4}>
      ...
      <div>
        <strong>use-context-menu</strong> is a set of components for building
        resizable panels like VS Code's "Folders" sidebar. It's used in
      ...
      <code className="grow text-xs md:text-sm block text-left whitespace-pre-wrap rounded-md p-3 bg-black text-white!">
        npm install <span className="tok-keyword">use-context-menu</span>
      </code>
      ...
      <ul className="pl-8">
        ...
        <li className="list-disc">
          <ExternalLink href="https://opencollective.com/use-context-menu#sponsor">
