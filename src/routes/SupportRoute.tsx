...
export default function SupportRoute() {
  return (
    <Box direction="column" gap={4}>
      ...
      <div>
        <ExternalLink href="https://github.com/bvaughn/use-context-menu">
          GitHub
        </ExternalLink>{" "}
      ...
      <div>
        ...
        <ExternalLink href="https://stackoverflow.com/search?q=use-context-menu">
          Stack Overflow
        </ExternalLink>{" "}
        or{" "}
        ...
        <ExternalLink href="https://github.com/bvaughn/use-context-menu/issues?q=is%3Aissue%20state%3Aclosed">
