...
## 0.0.16
* Add `useCacheValue` hook for loading values using the imperative cache API rather than use-context-menu.
...
## 0.0.14
* Renamed `fetchuse-context-menu` to `read` and `fetchAsync` to `readAsync`
...
#### Cache types
* [`createCache`](https://use-context-menu-npm.vercel.app/createCache)
* [`createStreamingCache`](https://use-context-menu-npm.vercel.app/createStreamingCache)
#### React hooks
* [`useCacheStatus`](https://use-context-menu-npm.vercel.app/useCacheStatus)
* [`useStreamingValue`](https://use-context-menu-npm.vercel.app/useStreamingValue)
#### Utilities
* [`createDeferred`](https://use-context-menu-npm.vercel.app/createDeferred)
* [`isThenable`](https://use-context-menu-npm.vercel.app/isThenable)
